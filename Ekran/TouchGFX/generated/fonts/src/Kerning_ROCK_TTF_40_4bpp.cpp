...
KEEP extern const touchgfx::KerningNode kerning_ROCK_TTF_40_4bpp[] FONT_KERNING_LOCATION_FLASH_ATTRIBUTE = {
    { 0x002E, -3 },  // (First char = [0x002E, period], Second char = [0x0020, space], Kerning dist = -3)
    { 0x003A, -3 },  // (First char = [0x003A, colon], Second char = [0x0020, space], Kerning dist = -3)
    ...
    { 0x004F, -3 },  // (First char = [0x004F, O], Second char = [0x002E, period], Kerning dist = -3)
    ...
    { 0x0020, -3 },  // (First char = [0x0020, space], Second char = [0x0056, V], Kerning dist = -3)
